...
```{r plot, echo=FALSE, fig.height= 4, fig.width=6, warning=FALSE, message=FALSE}
...
```{r plot1, echo=FALSE, fig.height= 5, fig.width=12, warning=FALSE, message=FALSE}
plot2<-plot(predtest$x,predtest$pred1, type='l', xlab='t /s', ylab='s1', col="red")
title(main="GLM model")
par(new=T)
plot(predtest$x,predtest$testing.hrate, type='l', xlab='', ylab='', axes=F, col="blue")
```

The Out of sample R-squared of the GLM model is `r round(R2glm,2)`.
...
```{r plot2, echo=FALSE, fig.height= 5, fig.width=12, warning=FALSE, message=FALSE}
plot2<-plot(predtest$x,predtest$pred2, type='l', xlab='t /s', ylab='s1', col="red")
title(main="KNN model")
par(new=T)
plot(predtest$x,predtest$testing.hrate, type='l', xlab='', ylab='', axes=F, col="blue")

```

The out of sample Rsquared of the KNN model is `r round(R2knn,2)`
